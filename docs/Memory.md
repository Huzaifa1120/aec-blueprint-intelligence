...
- [ ] **Phase 3 fixture gap:** no dedicated HVAC/duct sheet exists. `ABC-SC03-S101.pdf` can warm up equipment counting (`M-EQPT-*` layers) but duct/pipe route formulas need a real mechanical sheet from the owner.
